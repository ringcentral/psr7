...
class Utils
{
     ...
     */
    public static function stream_for($resource = '', array $options = array())
    {
     ...
     * @throws \RuntimeException on error.
     */
    public static function copy_to_stream(
     ...
     */
    public static function parse_server_request($message, array $serverParams = array())
    {
     ...
     * @internal
     */
    public static function _parse_message($message)
    {
        if (!$message) {
     ...
     * @internal
     */
    public static function _parse_request_uri($path, array $headers)
    {
