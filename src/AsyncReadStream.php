 ...
 */
class AsyncReadStream implements StreamableInterface
{
     ...
     *   (if known up-front).
     *
     * @param StreamableInterface $buffer   Buffer that contains the data that has
     ...
     *
     * - buffer: (StreamableInterface) Buffer used to buffer data. If none is
