...
use GuzzleHttp\Psr7\AsyncReadStream;
...
class AsyncReadStreamTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCreatesBufferWithNoConfig()
    {
        ...
        $this->assertInstanceOf('GuzzleHttp\Psr7\BufferStream', $buffer);
        $this->assertInstanceOf('GuzzleHttp\Psr7\AsyncReadStream', $async);
    }
    ...
    public function testCreatesNullStream()
    {
        ...
        $this->assertInstanceOf('GuzzleHttp\Psr7\NullStream', $buffer);
        $this->assertInstanceOf('GuzzleHttp\Psr7\AsyncReadStream', $async);
    }
    ...
    public function testCreatesDroppingStream()
    {
        ...
        $this->assertInstanceOf('GuzzleHttp\Psr7\DroppingStream', $buffer);
        $this->assertInstanceOf('GuzzleHttp\Psr7\AsyncReadStream', $async);
    ...
    public function testCreatesOnWriteStream()
    {
        ...
        $this->assertInstanceOf('GuzzleHttp\Psr7\FnStream', $buffer);
        $this->assertInstanceOf('GuzzleHttp\Psr7\AsyncReadStream', $async);
